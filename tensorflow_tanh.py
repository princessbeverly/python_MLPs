"""
Simple TensorFlow MLP Performance Tracker
- Detects GPU/CPU mode
- Tracks only 3 metrics: Training Time, Batch Time, Classification Time
- Uses MNIST_Dataset.py and Image.py
"""
...
class MLP_Classifier:
    ...
    def __init__(self, learning_rate=0.001):
        ...
        self.model = keras.Sequential([
            layers.Dense(256, activation='tanh', input_shape=(784,)),
